...
INSERT INTO sla_policies (id, name, enabled, conditions, metrics, sort_order, is_default) VALUES
  ...
  ('sla-lending-funding-closing',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["Funding Closing Issue"], "priorities": "any"}'::jsonb,
   '{"firstReplyHours": 1, "nextReplyHours": 2}'::jsonb,
   3, true),
  ...
  ('sla-lending-loan-status',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["Loan Status Change"], "priorities": "any"}'::jsonb,
   '{"firstReplyHours": 1, "nextReplyHours": 2}'::jsonb,
   4, true),
  ...
  ('sla-lending-condition-dispute',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["Condition Dispute"], "priorities": "any"}'::jsonb,
   '{"firstReplyHours": 4, "nextReplyHours": 8}'::jsonb,
   5, true),
  ...
  ('sla-lending-pre-approval',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["Pre-Approval Certified Buyer"], "priorities": "any"}'::jsonb,
   '{"firstReplyHours": 4, "nextReplyHours": 8}'::jsonb,
   6, true),
  ...
  ('sla-lending-trained-validation',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["Trained Validation"], "priorities": "any"}'::jsonb,
   '{"firstReplyHours": 4, "nextReplyHours": 8}'::jsonb,
   7, true),
  ...
  ('sla-lending-income-opinion',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["Income Opinion"], "priorities": "any"}'::jsonb,
  ...
  ('sla-lending-opinion-general',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["Opinion General"], "priorities": "any"}'::jsonb,
   '{"firstReplyHours": 8, "nextReplyHours": 16}'::jsonb,
   9, true),
  ...
  ('sla-lending-post-closing-audit',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["Post Closing Audit"], "priorities": "any"}'::jsonb,
   '{"firstReplyHours": 8, "nextReplyHours": 16}'::jsonb,
   10, true),
  ...
  ('sla-lending-pts-condition',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["PTS Condition Review"], "priorities": "any"}'::jsonb,
   '{"firstReplyHours": 8, "nextReplyHours": 16}'::jsonb,
   11, true),
  ...
  ('sla-lending-exception',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["Exception Request"], "priorities": "any"}'::jsonb,
   '{"firstReplyHours": 8, "nextReplyHours": 16}'::jsonb,
   12, true),
  ...
  ('sla-lending-condo-review',
   ...
   true,
   '{"ticketTypes": ["Lending Support"], "categories": ["Condo Review"], "priorities": "any"}'::jsonb,
